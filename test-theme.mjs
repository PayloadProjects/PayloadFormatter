...
assert.ok(html.includes("prefers-color-scheme: light"), 'first visit should respect the operating-system theme');
...
assert.ok(app.includes("prefers-color-scheme: light"));
